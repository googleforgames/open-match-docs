...
| extensions | [Backfill.ExtensionsEntry](#openmatch.Backfill.ExtensionsEntry) | repeated | Customized information not inspected by Open Match, to be used by the MatchMaking Function, evaluator, and components making calls to Open Match. Optional, depending on the requirements of the connected systems. |
